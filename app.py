...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "ME":
        return "uid=4925612754&password=K3INUKOTT67SUIS7AU5O6UAUKA235TIIO6KEIN93AUSUE42AUT7MMISU0TSSI163"
    elif r == "BD":
        return "uid=4270778393&password=MG24_GAMER_9NMYG_BY_SPIDEERIO_GAMING_FXK8R"
    elif r == "IND":
        return "uid=5232935551&password=SAITO_3PPKY_xSaeed_UNQZK"
    elif r in {"BR", "US", "SAC"}:
        return "uid=4855615134&password=AKANE_JAHID_X_EMPIRE_sDDCavPs"
    else:
...
if __name__ == '__main__':
    print("="*55)
    print("🚀 SAITOxFFINFO - Free Fire Info Website")
    print("="*55)
